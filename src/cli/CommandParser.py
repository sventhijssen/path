...
from cli.BDDPartitionCommand import BDDPartitionCommand
...
from cli.ReadCPLEXCommand import ReadCPLEXCommand
...
class CommandParser:
    ...
    def parse(raw_command: str):
        ...
        elif command_name == "partition":
            return BDDPartitionCommand(args)
        ...
        elif command_name == "read_cplex":
            return ReadCPLEXCommand(args)
        else:
